            ...
            >
              <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                ...
                <motion.p variants={fadeUp} style={{
                  ...
                  A two-week intensive program: one week of guided learning, one week of building. Culminates in a demo day with real cash prizes funded by Superteam Nigeria.
                </motion.p>
              </div>
